 ...
 */
$config['site_title']                 = "RtailERP";       // Site Title, example.com This is not more functional
$config['admin_email']                = "contact@retailpremier.com"; // Admin Email, admin@example.com This is not more functional
