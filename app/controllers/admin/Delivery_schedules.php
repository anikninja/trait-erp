...
/**
 * Class Delivery_schedules
 *
 * @property Delivery_schedule_model $schedule
 * @property Fc $fc
 */
class Delivery_schedules extends MY_Controller {
	...
	public function add_event() {
		...
		if ( $this->form_validation->run() == true ) {
			...
			if ( $this->schedule->addEvent( $data ) ) {
	...
	public function delete_event( $id ) {
		if ( $this->input->is_ajax_request() ) {
			if ( $event = $this->schedule->getEventByID( $id ) ) {
	...
	public function get_events() {
		...
		$input_arrays  = $this->schedule->getEvents( $start, $end );
	...
	public function index() {
		...
		$bc                     = [
			...
			[ 'link' => '#', 'page' => lang( 'delivery_schedules' ) ],
		];
		$meta                   = [ 'page_title' => lang( 'delivery_schedules' ), 'bc' => $bc ];
		$this->page_construct( 'delivery_schedules', $meta, $this->data );
	}
	...
	public function update_event() {
		...
		if ( $this->form_validation->run() == true ) {
			...
			if ( $this->schedule->updateEvent( $id, $data ) ) {
