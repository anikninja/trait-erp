...
class Promos extends MY_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == true) {
            $data = [
                ...
                'start_date'  => $this->input->post('start_date') ? $this->rerp->fsd(trim($this->input->post('start_date'))) : null,
                'end_date'    => $this->input->post('end_date') ? $this->rerp->fsd(trim($this->input->post('end_date'))) : null,
    ...
    public function delete($id = null)
    {
        ...
        if ($this->promos_model->deletePromo($id)) {
            $this->rerp->send_json(['error' => 0, 'msg' => lang('promo_deleted')]);
        }
    }
