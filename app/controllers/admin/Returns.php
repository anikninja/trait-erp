...
class Returns extends MY_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == true) {
            $date             = ($this->Owner || $this->Admin) ? $this->rerp->fld(trim($this->input->post('date'))) : date('Y-m-d H:i:s');
            ...
            $grand_total    = $this->rerp->formatDecimal(($total + $total_tax + $shipping - $order_discount), 4);
            $data           = [
                'date'              => $date,
    ...
    public function delete($id = null)
    {
        ...
        if ($this->returns_model->deleteReturn($id)) {
            if ($this->input->is_ajax_request()) {
                $this->rerp->send_json(['error' => 0, 'msg' => lang('return_deleted')]);
            }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            $date             = ($this->Owner || $this->Admin) ? $this->rerp->fld(trim($this->input->post('date'))) : $inv->date;
