...
class Quotes extends MY_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $grand_total    = $this->rerp->formatDecimal(($total + $total_tax + $this->rerp->formatDecimal($shipping) - $order_discount), 4);
            $data           = ['date' => $date,
    ...
    public function delete($id = null)
    {
        ...
        if ($this->quotes_model->deleteQuote($id)) {
            if ($this->input->is_ajax_request()) {
                $this->rerp->send_json(['error' => 0, 'msg' => lang('quote_deleted')]);
            }
    ...
    public function email($quote_id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $quote_temp = file_get_contents('themes/' . $this->Settings->adminTheme . 'email_templates/quote.html');
            ...
            if (!empty($_POST['val'])) {
                if ($this->input->post('form_action') == 'delete') {
                    ...
                    foreach ($_POST['val'] as $id) {
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('A' . $row, $this->rerp->hrld($qu->date));
