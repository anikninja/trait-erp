...
class Suppliers extends MY_Controller
{
    ...
    public function delete($id = null)
    {
        ...
        if ($this->companies_model->deleteSupplier($id)) {
            $this->rerp->send_json(['error' => 0, 'msg' => lang('supplier_deleted')]);
        } else {
            $this->rerp->send_json(['error' => 1, 'msg' => lang('supplier_x_deleted_have_purchases')]);
        }
    }
    ...
    public function getSupplier($id = null)
    {
        ...
        $this->rerp->send_json([['id' => $row->id, 'text' => $row->company]]);
    }
