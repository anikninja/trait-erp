...
class Paypal_payments extends CI_Model
{
    ...
    public function Do_direct_payment($amount, $currency, $cc, $desc = '', $sale_id = null)
    {
        $sale     = $sale_id ? $this->site->getSaleByID($sale_id) : $sale_id;
        $customer = $sale_id ? $this->site->getCompanyByID($sale->customer_id) : $sale_id;
        $DPFields = [
        ...
        $PayerInfo = [
            'email'       => $customer ? $customer->email : $desc, //'test@yahoo.com', // Email address of payer.
            'payerid'     => '', // Unique PayPal customer ID for payer.
            'payerstatus' => '', // Status of payer.  Values are verified or unverified
            'business'    => $customer ? $customer->company : '',        // Payer's business name.
        ];
        ...
        $BillingAddress = [
            'street'      => $customer ? $customer->address : '', //'707 W. Bay Drive', // Required.  First street address.
            'street2'     => '', // Second street address.
            'city'        => $customer ? $customer->city : '', //'Largo', // Required.  Name of City.
            'state'       => $customer ? $customer->state : '', //'FL', // Required. Name of State or Province.
            'countrycode' => $customer ? $customer->country : '', //'US', // Required.  Country code.
            'zip'         => $customer ? $customer->postal_code : '', //'33770', // Required.  Postal code of payer.
            'phonenum'    => $customer ? $customer->phone : '',       // Phone Number of payer.  20 char max.
        ];
        ...
        $PaymentDetails = [
            ...
            'desc'         => 'Payment of sale number ' . $sale_id, // Description of the order the customer is purchasing.  127 char max.
            'custom'       => $sale->reference_no . '__' . ($sale->grand_total - $sale->paid) . '__0', // Free-form field for your own use.  256 char max.
            'invnum'       => $sale_id, // Your own invoice or tracking number
    ...
    {
        $GBFields          = ['returnallcurrencies' => '1'];
        $PayPalRequestData = ['GBFields' => $GBFields];
        ...
        //$this->load->view('paypal_error', $errors);
            ...
            return ['amount' => $data['PayPalResult']['BALANCERESULTS'], 'time' => $this->rerp->hrld($data['PayPalResult']['TIMESTAMP'])];
    ...
    public function Get_transaction_details($transactionid)
    {
        ...
        $PayPalRequestData = ['GTDFields' => $GTDFields];
    ...
    public function Refund_transaction()
    {
        ...
        $PayPalRequestData = ['RTFields' => $RTFields];
