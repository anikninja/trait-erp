        ...
        cartHandler = function () {
                    ...
                    $.each( cartData.contents, function () {
                        ...
                        <div class="product product-${item.product_id} single-cart-item">
                            ...
                            <div class="cart-qty-input">
                                <button class="cart-qty qty-inc cart-item-increase-btn">+</button>
                                <span class="cart-qty-count cart-item-qty-input">${item.qty}</span>
                                <button class="cart-qty qty-desc cart-item-decrease-btn">-</button>
                            </div>
                            <div class="cart-item-photo">
                                <a class="view-product" href="${site_url}product/${item.slug}">
                                    <img src="${item.image}" alt="${item.name}">
                                </a>
                            </div>
                            <div class="cart-item-details">
                                <div class="cart-item-title">
                                    <a class="view-product" href="${site_url}product/${item.slug}">${item.name}</a>
                                </div>
                            ...
                            <div class="cart-item-amount"><p>${item.subtotal}</p></div>
            ...
            .on('click', '.add-to-cart', function( e ) {
                ...
                if ( prodData.isVariable ) {
                    ...
                    if ( prodData.attributes.idMap.hasOwnProperty( optionName ) ) {
                        option = prodData.attributes.idMap[ optionName ];
                    }
                }
        ...
        if ( 'shop/products' !== pageNow ) {
            ...
            __AutoSearch__.autocomplete( {
                ...
                formatResult: function( suggestion, currentValue ) {
                    ...
                    //     add_to_cart: "http://pxwp.com/RetailERP/cart/add/344?qty=1",
                    //     brand_name: "Bengol",
                    //     brand_slug: "bengol",
                    //     cartQty: 0,
                    ...
                    //     formated_promo_price: "0.00",
                    //     formated_special_price: "0.00",
                    //     id: "344",
                    //     image: "http://pxwp.com/RetailERP/themes/coloursports/shop/assets/no_image.jpg",
                    //     inCart: false,
                    //     link: "http://pxwp.com/RetailERP/product/bengal-duples-cardamommilk-double-cream-biscuits",
                    //     meta_description: "",
                    //     meta_image: "http://pxwp.com/RetailERP/assets/uploads/logos/logo@2x.png",
                    //     meta_title: "E21-65 - Bengal Duples (cardamom+milk) Double Cream Biscuits",
                    //     name: "Bengal Duples (cardamom+milk) Double Cream Biscuits",
                    //     price: "50.0000",
                    //     promo_price: 0,
                    //     promotion: "0",
                    //     quantity: "0.0000",
                    ...
                    //     sale_price: "",
                    //     saved: "",
                    //     slug: "bengal-duples-cardamommilk-double-cream-biscuits",
                    //     special_price: 0,
                    //     start_date: null,
                    //     subcategory_name: "Cookies &amp; Cake",
                    //     subcategory_slug: "cookies-cake",
                    //     type: "standard",
                    //     unit_code: "240GM",
                    //     unit_name: "240 gm",
                    // }
                    ...
                    if ( 'shop/wishlist' === pageNow ) {
                        if ( ! add ) {
                            ...
                            if ( prodData && prodData.hasOwnProperty( 'id' ) ) {
                                ...
                                __HTML__.ac( prodData.inCart ? 'added-in-cart' : 'not-added-in-cart' );
