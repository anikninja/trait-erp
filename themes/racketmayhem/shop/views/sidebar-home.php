                    ...
                    <div class="module product-simple <?= $section['type']; ?>">
                        ...
                        <div class="modcontent">
                            <div class="so-extraslider">
                                <!-- Begin sidebar-slider-inner -->
                                <div class="sidebar-slider-inner products-list sidebar-slider" data-effect="none">
                                <?php
                                $new_products_chunk = array_chunk( $section['products'], 4);
                                foreach ( $new_products_chunk as $products ) { ?>
                                    <div class="item ">
                                    <?php foreach ($products as $product) {
                                        get_single_product_loop_third_layout( $product, true );
                                    } ?>
                                    </div>
                                <?php } ?>
                                </div>
