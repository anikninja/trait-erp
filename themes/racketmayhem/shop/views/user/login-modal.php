		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="main-content sign-in-form">
					...
					<input type="text" name="identity" placeholder="<?= lang( 'username' ); ?>" required>
				...
				<div class="main-content sign-up-form" style="display: none;">
					...
					<p>By signing up, you agree to Grocerant</p>
					...
					<input type="text" name="phone" placeholder="<?= lang( 'phone' ); ?>" pattern=".{10,14}" required>
					...
					<input type="password" name="password" placeholder="<?= lang( 'password' ); ?>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
					<input type="password" name="password_confirm" placeholder="<?= lang( 'confirm_password' ); ?>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
					<p style="padding: 20px 0px 30px;">By signing up, you agree to Grocerant's <a href="/">Terms &amp; Condition</a></p>
					<button type="submit" class="button"><?= lang( 'continue' ); ?></button>
					<?= form_close(); ?>
