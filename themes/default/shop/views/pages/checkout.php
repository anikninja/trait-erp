...
<section class="page-contents">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
	                <?php // Checkout Details. ?>
                    <div class="col-sm-8">
                        <div class="panel panel-default margin-top-lg">
                            <div class="panel-heading text-bold">
                                <i class="fa fa-shopping-cart margin-right-sm"></i> <?= lang('checkout'); ?>
                                <a href="<?= site_url('cart'); ?>" class="pull-right"><i class="fa fa-share"></i> <?= lang('back_to_cart'); ?></a>
                            </div>
                                    ...
                                    <div class="tab-content padding-lg">
                                        <div role="tabpanel" class="tab-pane fade in active" id="user">
                                            ...
                                            if ($this->loggedIn) {
	                                            ...
	                                            <?php include get_template_file_path( 'pages/payment_methods.php', $Settings->theme ); ?>
                                                <hr>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="well margin-bottom-no">
                                                            <?php include get_template_file_path( 'user/login_form.php', $Settings->theme ); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-striped table-borderless cart-totals margin-bottom-no">
                                        <tr>
                                            ...
                                            <td class="text-right"><?= $this->rerp->convertMoney($this->cart->total() - $this->cart->total_item_tax()); ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('product_tax'); ?></td>
                                            <td class="text-right"><?= $this->rerp->convertMoney($this->cart->total_item_tax()); ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('total'); ?></td>
	                                        <td class="text-right"><?= $this->rerp->formatMoney( $total, $selected_currency->symbol ); ?></td>
                                        </tr>
                                        <?php if ($Settings->tax2 !== false) {
                                        echo '<tr><td>' . lang('order_tax') . '</td><td class="text-right">' . $this->rerp->formatMoney($order_tax, $selected_currency->symbol) . '</td></tr>';
                                    } ?>
                                        <tr>
                                            <td><?= lang('shipping'); ?> *</td>
                                            <td class="text-right"><?= $this->rerp->formatMoney($shipping, $selected_currency->symbol); ?></td>
                                        </tr>
                                        <tr><td colspan="2"></td></tr>
                                        <tr class="active text-bold">
                                            <td><?= lang('grand_total'); ?></td>
                                            <td class="text-right"><?= $this->rerp->formatMoney(($this->rerp->formatDecimal($total) + $this->rerp->formatDecimal($order_tax) + $this->rerp->formatDecimal($shipping)), $selected_currency->symbol); ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
