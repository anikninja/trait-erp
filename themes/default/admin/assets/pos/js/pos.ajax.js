    ...
    if (localStorage.getItem('positems')) {
        ...
        $.each(sortedItems, function() {
            ...
            tr_html =
                ...
                item_name +
                (sel_opt != '' ? ' (' + sel_opt + ')' : '') +
                '</span><span class="lb"></span><i class="pull-right fa fa-edit fa-bx tip pointer edit" id="' +
                row_no +
                '" data-item="' +
                item_id +
                '" title="Edit" style="cursor:pointer;"></i><i class="pull-right fa fa-comment fa-bx' +
                (item_comment != '' ? '' : '-o') +
            ...
            tr_html +=
                ...
                '</span></td>';
            tr_html +=
                '<td><input class="form-control input-sm kb-pad text-center rquantity" tabindex="' +
