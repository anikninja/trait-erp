...
function cssStyle() {
    ...
    } else if ($.cookie('rerp_style') == 'blue') {
    ...
    if ($('#sidebar-left').hasClass('minified')) {
        $.cookie('rerp_theme_fixed', 'no', { path: '/' });
        ...
        if ($.cookie('rerp_theme_fixed') == 'yes') {
    ...
    $('#fixed').click(function(e) {
        ...
        if ($('#sidebar-left').hasClass('minified')) {
            ...
            if ($(this).hasClass('fixed')) {
                ...
                $.cookie('rerp_theme_fixed', 'yes', { path: '/' });
            }
            cssStyle();
        }
    });
...
function widthFunctions(e) {
    ...
    if (ww > 1024 && $.cookie('rerp_sidebar') != 'minified') {
        $('#main-menu-act')
            .removeClass('minified')
            .addClass('full')
            .find('i')
...
jQuery(document).ready(function(e) {
    e('#main-menu-act').click(function() {
        if (e(this).hasClass('full')) {
            $.cookie('rerp_sidebar', 'minified', { path: '/' });
            e(this)
                .removeClass('full')
                .addClass('minified')
                .find('i')
...
$(document).ready(function() {
    ...
    $(document).on('click', '.po', function(e) {
        ...
        $('.po')
            .popover({ html: true, placement: place, trigger: 'manual' })
            .popover('show')
            .not(this)
            .popover('hide');
        return false;
...
$(document).ready(function() {
    if ($.cookie('rerp_sidebar') == 'minified') {
        $('#main-menu-act')
            .removeClass('full')
            .addClass('minified')
            .find('i')
...
$(document).ready(function() {
    $('#cssLight').click(function(e) {
        e.preventDefault();
        $.cookie('rerp_style', 'light', { path: '/' });
        cssStyle();
        return true;
    });
    $('#cssBlue').click(function(e) {
        e.preventDefault();
        $.cookie('rerp_style', 'blue', { path: '/' });
        cssStyle();
        return true;
    });
    $('#cssBlack').click(function(e) {
        e.preventDefault();
        $.cookie('rerp_style', 'black', { path: '/' });
        cssStyle();
        return true;
    });
...
function img_hl(x) {
    var image_link = x == null || x === '' ? noImage : site.url + 'assets/uploads/' + x;
    var thumb_link = x == null || x === '' ? noImage : site.url + 'assets/uploads/thumbs/' + x;
    return (
        '<div class="text-center">'
        + '<a href="' + image_link + '" data-toggle="lightbox">'
        + '<img src="' + thumb_link + '" alt="" style="width:30px; height:30px;">'
        + '</a>'
        + '</div>'
    );
}
...
$(document).ready(function() {
    ...
    $('body').on('click', '.shipment_link td:not(:first-child, :nth-last-child(2), :last-child)', function() {
        $('#myModal').modal({
            remote:
                site.base_url +
                'delivery/view_shipment/' +
                $(this)
                    .parent('.shipment_link')
                    .attr('id'),
        });
        $('#myModal').modal('show');
    });
...
function openImg(img) {
    var imgwindow = window.open('', 'rerp_pos_img');
