...
$(function() {
    $('.datetime').datetimepicker({format: site.dateFormats.js_ldate, language: 'rerp', weekStart: 1, todayBtn: 1, autoclose: 1, todayHighlight: 1, startView: 2, forceParse: 0});
    $('.date').datetimepicker({format: site.dateFormats.js_sdate, language: 'rerp', todayBtn: 1, autoclose: 1, minView: 2 });
});
