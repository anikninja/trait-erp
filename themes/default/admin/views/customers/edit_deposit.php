        ...
        <div class="modal-body">
            ...
            ?>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('date', set_value('date', $this->rerp->hrld($deposit->date)), 'class="form-control datetime" id="date" required="required"'); ?>
                        </div>
                    </div>
                    <?php
        } ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('amount', set_value('amount', $this->rerp->formatMoney($deposit->amount)), 'class="form-control" id="amount" required="required"'); ?>
                        </div>
                    </div>
