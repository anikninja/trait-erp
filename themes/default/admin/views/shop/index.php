        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <?= sprintf( lang('shipping_label', 'shipping'), lang( 'flat_rate_shipping_label' ) ); ?>
                            <?= form_input('shipping', set_value('shipping', $shop_settings->shipping), 'class="form-control tip" id="shipping"'); ?>
                        </div>
	                    <div class="form-group">
		                    <?= sprintf( lang('free_shipping_threshold', 'free_shipping') ); ?>
		                    <?php $title = lang( 'free_shipping_info' ); ?>
		                    <?= form_input('free_shipping', set_value('free_shipping', isset( $shop_settings->free_shipping ) ? $shop_settings->free_shipping : 0 ), 'class="form-control tip" id="free_shipping" title="'.$title.'"'); ?>
	                    </div>
	                    <div class="form-group">
		                    <?= lang('minimum_checkout_threshold', 'minimum_order'); ?>
		                    <?php $title = lang( 'minimum_checkout_info' ); ?>
		                    <?= form_input('minimum_order', set_value('minimum_order', isset( $shop_settings->minimum_order ) ? $shop_settings->minimum_order : 0 ), 'class="form-control tip" id="minimum_order" title="'.$title.'"'); ?>
	                    </div>
                    </div>
	                <!-- Shop Contact -->
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_dropdown('about_link', $pages, set_value('about_link', $shop_settings->about_link), 'class="form-control tip" id="about_link"  required="required"'); ?>
                        </div>
                        <div class="form-group">
                            <?= lang('terms_link', 'terms_link'); ?>
                            <?= form_dropdown('terms_link', $pages, set_value('terms_link', $shop_settings->terms_link), 'class="form-control tip" id="terms_link"  required="required"'); ?>
                        </div>
                        <div class="form-group">
                            <?= lang('privacy_link', 'privacy_link'); ?>
                            <?= form_dropdown('privacy_link', $pages, set_value('privacy_link', $shop_settings->privacy_link), 'class="form-control tip" id="privacy_link"  required="required"'); ?>
                        </div>
                        <div class="form-group">
                            <?= lang('contact_link', 'contact_link'); ?>
                            <?= form_dropdown('contact_link', $pages, set_value('contact_link', $shop_settings->contact_link), 'class="form-control tip" id="contact_link"  required="required"'); ?>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
	                    <div class="form-group">
		                    <?= lang('delivery_slot_offset', 'delivery_slot_offset'); ?>
		                    <?= form_input( 'delivery_slot_offset', set_value('delivery_slot_offset', isset( $shop_settings->delivery_slot_offset ) ? $shop_settings->delivery_slot_offset : 0 ), 'min="0" max="12" class="form-control tip" id="delivery_slot_offset"' ); ?>
		                    <code><?= lang( 'delivery_slot_offset_time_format_info' ); ?></code>
	                    </div>
                        <div class="form-group">
	                        <?= lang('wallet_percentage_cart', 'wallet_percentage_cart'); ?>
	                        <?= form_input( 'wallet_percentage_cart', set_value('wallet_percentage_cart', isset( $shop_settings->wallet_percentage_cart ) ? $shop_settings->wallet_percentage_cart : 0 ), 'min="0" max="100" class="form-control tip" id="wallet_percentage_cart"' ); ?>
                        </div>
	                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_dropdown('cookie_link', $pages, set_value('cookie_link', $shop_settings->cookie_link), 'class="form-control tip" id="cookie_link"'); ?>
                        </div>
                        <div class="form-group">
                            <?= lang('hide0', 'hide0'); ?>
                            <?php $yn = [0 => lang('no'), 1 => lang('yes')]; ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <?= lang('logo', 'logo'); ?>
	                        <br>
                            <input id="logo" type="file" data-browse-label="<?= lang('browse'); ?>" accept="image/gif,image/jpg,image/jpeg,image/png" name="logo" data-show-upload="false" data-show-preview="false" class="form-control file">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
	                        <?= lang( 'mc_api', 'mc_api' ); ?>
	                        <?= form_input( 'mc_api', set_value( 'mc_api', $shop_settings->mc_api ), 'class="form-control tip" id="mc_api" placeholder="MailChimpAPI_bc123abc123abc123-us1,ListID"' ); ?>
                        </div>
                    </div>
                    <!-- bank details moved to system_settings/bank <div class="col-md-12">
                        <div class="form-group">
