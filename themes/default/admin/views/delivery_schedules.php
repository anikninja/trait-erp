...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-calendar"></i><?= lang('delivery_schedules'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <p class="introtext"><?= lang('delivery_schedules_line') ?></p>
                <div id='calendar'></div>
                <div class="modal fade schedule_modal">
                            ...
                            <div class="modal-body">
                                ...
                                <form>
                                    ...
                                    <div class="form-group">
                                        <?= lang('title', 'title'); ?>
                                        <?= form_input('title', set_value('title'), 'class="form-control tip" id="title" readonly'); ?>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <?= lang('start', 'start'); ?>
                                                <?= form_input('start', set_value('start'), 'class="form-control" id="start" readonly'); ?>
                                                <?php //form_input('start', set_value('start'), 'class="form-control datetime" id="start" required="required" readonly'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <?= lang('end', 'end'); ?>
                                                <?= form_input('end', set_value('end'), 'class="form-control" id="end" readonly'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <?= lang('delivery_status', 'd_status'); ?>
                                                <?= form_input('status', set_value('d_status'), 'class="form-control" id="d_status" readonly'); ?>
	                                            <a href="#" class="btn btn-primary tip add-delivery" data-toggle="modal" data-target="#myModal" title="<?= lang( 'add_delivery'); ?>"><i class="fa fa-truck"></i></a>
                                            </div>
                                        </div>
                                        <!--<div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <?= lang('customers_note', 'customers_note'); ?>
                                        <textarea class="form-control skip" id="description" name="note" readonly></textarea>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript">
    ...
    var delivery_status = <?= json_encode( [
...
<script src='<?= $assets ?>fullcalendar/js/delivery-schedule.js'></script>
