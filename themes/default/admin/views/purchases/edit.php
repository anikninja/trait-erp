                    ...
                    ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang('date', 'podate'); ?>
                                    <?php echo form_input('date', ($_POST['date'] ?? $this->rerp->hrld($purchase->date)), 'class="form-control input-tip datetime" id="podate" required="required"'); ?>
                                </div>
                            </div>
                        <?php
                } ?>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            echo form_dropdown('category', $cat, '', 'class="form-control select" id="mcategory" placeholder="' . sprintf( lang( 'select_x' ), lang( 'category' ) ) . '" style="width:100%"')
                            ?>
                        </div>
                        <div class="form-group">
                            <?= lang('unit', 'munit') ?> *
