            ...
            ?>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <?= lang('date', 'date'); ?>
                            <?= form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->rerp->hrld($payment->date)), 'class="form-control datetime" id="date" required="required"'); ?>
                        </div>
                    </div>
                <?php
        } ?>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid"
                                               value="<?= $this->rerp->formatDecimal($payment->amount); ?>" type="text"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="paid_by" id="paid_by_1" class="form-control paid_by" required="required">
                                            <?= $this->rerp->paid_opts($payment->paid_by, true); ?>
                                    </select>
                                </div>
                            </div>
