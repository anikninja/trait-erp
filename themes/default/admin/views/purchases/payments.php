    ...
    foreach ($payments as $payment) {
        ?>
                            <tr class="row<?= $payment->id ?>">
                                ...
                                <td><?= $this->rerp->formatMoney($payment->amount) . ' ' . (($payment->attachment) ? '<a href="' . admin_url('welcome/download/' . $payment->attachment) . '"><i class="fa fa-chain"></i></a>' : ''); ?></td>
                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <a href="<?= admin_url('purchases/email_payment/' . $payment->id) ?>" class="email_payment"><i class="fa fa-envelope"></i></a>
                                        ...
                                        <a href="#" class="po" title="<b><?= $this->lang->line('delete_payment') ?></b>"
                                           data-content="<p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' id='<?= $payment->id ?>' href='<?= admin_url('purchases/delete_payment/' . $payment->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn po-close'><?= lang('no') ?></button>"
