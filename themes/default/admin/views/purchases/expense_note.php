    ...
    ?>
            ...
            <div class="well">
                <table class="table table-borderless" style="margin-bottom:0;">
                    ...
                    <tr>
                        ...
                        <td><strong class="text-right"><?php echo $this->rerp->hrld($expense->date); ?></strong></td>
                    </tr>
                    <tr>
        ...
        ?>
                    ...
                    <tr>
                        ...
                        <td><strong class="text-right"><?php echo $this->rerp->formatMoney($expense->amount); ?></strong>
                        </td>
                    </tr>
                    <tr>
