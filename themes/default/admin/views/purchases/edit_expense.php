        ...
        <div class="modal-body">
            ...
            ?>
                ...
                <div class="form-group">
                    <?= lang('date', 'date'); ?>
                    <?= form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->rerp->hrld($expense->date)), 'class="form-control datetime" id="date" required="required"'); ?>
                </div>
            <?php
        } ?>
            ...
            <div class="form-group">
                ...
                <?php
                $ct[''] = sprintf( lang( 'select_x' ), lang( 'category' ) );
            ...
            <div class="form-group">
                <?= lang('amount', 'amount'); ?>
                <input name="amount" type="text" id="amount" value="<?= $this->rerp->formatDecimal($expense->amount); ?>"
