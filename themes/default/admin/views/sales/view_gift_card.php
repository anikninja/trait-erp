                    ...
                    <div class="card-content white-text">
                        <svg xmlns="http://www.w3.org/2000/svg" width="353px" height="206px" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <text x="5"  y="75" style="font-size:36;fill:#FFF;">
                                <?= $Settings->default_currency . ' ' . $this->rerp->formatMoney($gift_card->value); ?>
                            </text>
                            ...
                            <text x="5"  y="115" style="font-size:14;fill:#FFF;">
                                <?= $gift_card->expiry ? lang('expiry') . ': ' . $this->rerp->hrsd($gift_card->expiry) : ''; ?>
                            </text>
        ...
        ?>
            ...
            if ($topups) {
                ...
                foreach ($topups as $topup) {
                    echo '<tr>';
                    echo '<td>' . $this->rerp->hrld($topup->date) . '</td>';
                    echo '<td>' . $this->rerp->formatMoney($topup->amount) . '</td>';
