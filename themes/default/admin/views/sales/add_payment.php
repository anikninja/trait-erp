            ...
            ?>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?php if (isset($_GET['reference_no']) ) { ?>
                        <?= form_input('reference_no', $_GET['reference_no'], 'class="form-control tip" id="reference_no"'); ?>
                        <?php  } else { ?>
                                ...
                                <div class="payment">
                                    <div class="form-group">
	                                    ...
	                                    <?php if (isset($_GET['amount']) ) { ?>
		                                    <?= form_input('amount-paid', $this->rerp->formatDecimal($_GET['amount']), 'class="pa form-control kb-pad amount" id="amount_1" required="required"'); ?>
	                                    <?php  } else { ?>
                                        <input name="amount-paid" type="text" id="amount_1"
                                               value="<?= $this->rerp->formatDecimal($inv->grand_total - $inv->paid); ?>"
