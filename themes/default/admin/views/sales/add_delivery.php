                ...
                <div class="col-md-6">
                    <?php if ($Owner || $Admin) { ?>
                        <div class="form-group">
                            <?php
                            if ( $scheduled ) {
                            	echo lang('date', '_date');
	                            echo form_input('date', $date, 'class="form-control" id="_date" readonly');
                            } else {
	                            echo lang('date', 'date');
	                            echo form_input('date', $date, 'class="form-control datetime" id="date" required="required"');
                            }
                            ?>
                        </div>
                    <?php } ?>
            ...
            isset($_POST['address']) ? $_POST['address']
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <?= lang('status', 'status'); ?>
                        <?php
                        $opts = [ 'pending' => lang( 'pending' ), 'packing' => lang('packing'), 'delivering' => lang('delivering'), 'delivered' => lang('delivered')];
                        ?>
