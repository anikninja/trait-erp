...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        <?php if ($quote_id) {
    ?>
        // localStorage.setItem('sldate', '<?= $this->rerp->hrld($quote->date) ?>');
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    echo form_input($warehouse_input);
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
			                    <?= lang('apply_coupon', 'coupon_code'); ?>
			                    <?php echo form_input('coupon_code', '', 'class="form-control input-tip" id="coupon_code"'); ?>
