            ...
            <div class="col-lg-12">
                ...
                <div class="col-xs-8 pull-right">
                    <div class="col-xs-12 text-right order_barcodes">
                        ...
                        <?= $this->rerp->qrcode('link', urlencode(admin_url('quotes/view/' . $inv->id)), 2); ?>
                    </div>
                    <div class="clearfix"></div>
                </div>
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; width:100px; padding-right:10px;"><?= $this->rerp->formatMoney($row->unit_price); ?></td>
                                <?php
                                if ($Settings->tax1 && $inv->product_tax > 0) {
                        ...
                        <tr>
                            ...
                            ?>
                            <td style="text-align:right; padding-right:10px;"><?= $this->rerp->formatMoney($inv->total + $inv->product_tax); ?></td>
                        </tr>
                        <?php if ($Settings->indian_gst) {
                                if ($inv->cgst > 0) {
                        ...
                        if ($inv->order_discount != 0) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang('order_discount') . ' (' . $default_currency->code . ')</td><td style="text-align:right; padding-right:10px;">' . ($inv->order_discount_id ? '<small>(' . $inv->order_discount_id . ')</small> ' : '') . $this->rerp->formatMoney($inv->order_discount) . '</td></tr>';
                        }
                        if ($Settings->tax2 && $inv->order_tax != 0) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang('order_tax') . ' (' . $default_currency->code . ')</td><td style="text-align:right; padding-right:10px;">' . $this->rerp->formatMoney($inv->order_tax) . '</td></tr>';
                        }
                        if ($inv->shipping != 0) {
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; padding-right:10px; font-weight:bold;"><?= $this->rerp->formatMoney($inv->grand_total); ?></td>
                        </tr>
