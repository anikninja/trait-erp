            ...
            <div class="well well-sm">
                <div class="row bold">
                    ...
                    <div class="col-xs-7 text-right order_barcodes">
                        ...
                        <?= $this->rerp->qrcode('link', urlencode(admin_url('products/view_adjustment/' . $inv->id)), 2); ?>
                    </div>
                ...
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    ?>
                        <tr>
                            ...
                            <th><?= $row->variant; ?></th>
                            <th><?= lang($row->type); ?></th>
                            <td style="width: 80px; text-align:center; vertical-align:middle;"><?= $this->rerp->formatQuantity($row->quantity); ?></td>
                        </tr>
                        <?php
                        $r++;
                    endforeach;
