        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-xs-5">
	                ...
	                ?>
                    <img id="pr-image" src="<?= $image ? $image : $Settings->noImage; ?>" alt="<?= $product->name ?>" class="img-responsive img-thumbnail"/>
                    <div id="multiimages" class="padding10">
                        <?php
                        $style = "max-width:{$Settings->twidth}px; max-height:{$Settings->theight}px;";
                        if ( ! empty( $images ) ) {
                        	if ( $image ) {
	                            $image = get_image_url( $product->image, true, true );
	                        } else {
		                        $image = $Settings->noImage;
	                        }
	                        
                        	echo '<a class="img-thumbnail change_img" href="' . $image . '" style="margin-right:5px;">' .
	                                '<img class="img-responsive" src="' . $image . '" style="' . $style . '">' .
	                             '</a>';
	                        foreach ( $images as $ph ) {
                                ...
                                echo '<div class="gallery-image">' .
                                     '<a class="img-thumbnail change_img" href="' . $photo . '" style="margin-right:5px;">' .
                            ...
                            if ($this->session->userdata('show_price')) {
                                ...
                                if ($product->promotion) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $this->rerp->formatQuantity($product->alert_quantity); ?></td>
                                    </tr>
                                    <?php
                                    } ?>
                                    <?php if ($variants) {
                            ...
                            foreach ($options as $option) {
                                if ($option->wh_qty != 0) {
                                    ...
                                    if ($Owner || $Admin && (!$Customer || $this->session->userdata('show_cost'))) {
                                        echo '<td class="text-right">' . $this->rerp->formatMoney($option->price) . '</td>';
                                    }
                                    echo '</tr>';
                                }
                            } ?>
