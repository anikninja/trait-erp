            ...
            <table width="100%" class="stable">
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;">
                            <h4><span><?= $this->rerp->formatMoney($costing->sales); ?></span></h4>
                            <!-- <h4><span><?= $this->rerp->formatMoney($costing->sales) . ' (' . $this->rerp->formatMoney($costing->net_sales) . ')'; ?></span></h4>-->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;">
                        <h4><span><?= $this->rerp->formatMoney($costing->cost); ?></span></h4>
                        <!-- <h4><span><?= $this->rerp->formatMoney($costing->cost) . ' (' . $this->rerp->formatMoney($costing->net_cost) . ')'; ?></span></h4> -->
                    </td>
                </tr>
                <tr>
