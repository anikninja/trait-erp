                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php
                                $cat[''] = sprintf( lang( 'select_x' ), lang( 'category' ) );
                                foreach ($categories as $category) {
                                    $cat[$category->id] = $category->name;
                                }
                                echo form_dropdown('category', $cat, (isset($_POST['category']) ? $_POST['category'] : ''), 'class="form-control select" id="category" placeholder="' . sprintf( lang( 'select_x' ), lang( 'category' ) ) . '" style="width:100%"')
                                ?>
                            </div>
                        </div>
