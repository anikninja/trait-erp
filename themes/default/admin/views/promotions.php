...
<head>
    ...
    <title>RetailERP Promotional Page</title>
        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">POS Module for RtailERP</h1>
                    <p class="lead">RtailERP is php based web application for small and medium business to manage inventory, sales (with online payments), expenses, customers and warehouses. </p>
                    <p>Please edit themes/<?=$Settings->adminTheme;?>promotions.php</p>
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>RtailERP Advacne by <a href="http://retailpremier.com">RetailERP</a>.</p>
                    </div>
                </div>
            </div>
        </div>
