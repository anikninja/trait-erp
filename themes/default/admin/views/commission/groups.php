...
<script>
    $(document).ready(function () {
        oTable = $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('commission/getCommissionGroups') ?>',
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, null, null, null, { mRender: function( status ) {
            	return status ? '<?= lang( 'active' ); ?>' : '<?= lang( 'inactive' ); ?>';
            } }, {"bSortable": false}]
        });
    });
</script>
<?= admin_form_open('commission/group_actions', 'id="action-form"') ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="lni-offer"></i><?= lang('commission_groups'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('commission/add_group'); ?>"><i class="fa fa-plus"></i> <?= sprintf( lang('add_x'), lang( 'commission_group' ) ); ?></a>
                        </li>
                        <li class="divider"></li>
                        <li>
