...
<script>
    $(document).ready(function () {
        oTable = $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('wallet/getWalletDetails/'.$user->getId() ) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('user_wallet_details'); ?></h2>
    </div>
			...
			<div class="col-md-8 col-md-offset-2">
				...
				<div class="panel-group">
					<div class="panel panel-default">
						<div class="panel-heading text-bold"><?= sprintf( lang( 'x_s_wallet_balance' ), $user->getDisplayName() ); ?></div>
						<div class="checkout-step-content-wrap">
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-md-6">
										<p><?= sprintf( lang( 'total_balance_x' ), $this->rerp->convertMoney( $wallet->getAmount() ) ); ?></p>
