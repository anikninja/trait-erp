...
<script>
    $(document).ready(function () {
        oTable = $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('wallet/getWalletList') ?>',
            ...
            "aoColumns": [ null, { mRender: currencyFormat }, { mRender: fld }, { "bSortable": false } ]
        });
    });
</script>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('wallet_list'); ?></h2>
    </div>
