                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo form_input('start_date', $promo->start_date ? $this->rerp->hrsd($promo->start_date) : '', 'class="form-control tip date" id="start_date"'); ?>
                        </div>
                        <div class="form-group">
                            <?= lang('end_date', 'end_date'); ?>
                            <?php echo form_input('end_date', $promo->end_date ? $this->rerp->hrsd($promo->end_date) : '', 'class="form-control tip date" id="end_date"'); ?>
                        </div>
                        <div class="form-group">
