    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="myModalLabel"><?= lang('sales') . ' (' . $this->rerp->hrld($this->session->userdata('register_open_time')) . ' - ' . $this->rerp->hrld(date('Y-m-d H:i:s')) . ')'; ?></h4>
        </div>
            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    ...
                    <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                            <span><?= $this->rerp->formatMoney($gcsales->paid ? $gcsales->paid : '0.00') . ' (' . $this->rerp->formatMoney($gcsales->total ? $gcsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
        ...
        ?>
                ...
                <tr>
                    ...
                    <td width="200px;" style="font-weight:bold;text-align:right;"><h4>
                            <span><?= $this->rerp->formatMoney($totalsales->paid ? $totalsales->paid : '0.00') . ' (' . $this->rerp->formatMoney($totalsales->total ? $totalsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;border-top: 1px solid #DDD;"><h4>
                            <span><?= $this->rerp->formatMoney($returns->total ? '-' . $returns->total : '0.00'); ?></span>
                        </h4></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                            <span><strong><?= $cashsales->paid ? $this->rerp->formatMoney(($cashsales->paid + ($this->session->userdata('cash_in_hand'))) + ($refunds->returned ? $refunds->returned : 0) - ($returns->total ? $returns->total : 0) - $expense) : $this->rerp->formatMoney($this->session->userdata('cash_in_hand') - $expense - ($returns->total ? $returns->total : 0)); ?></strong></span>
                        </h4></td>
                </tr>
            </table>
        </div>
