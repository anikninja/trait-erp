    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <?= form_dropdown('code', array_merge( [ '' => '' ], ci_get_currencies() ), $currency->code, 'class="form-control select" id="code" placeholder="' . lang('select') . ' ' . lang('currency_code') . '" style="width:100%" required="required"'); ?>
            </div>
