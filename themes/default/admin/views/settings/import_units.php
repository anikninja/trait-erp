...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <a href="<?php echo base_url(); ?>assets/csv/sample_units.csv" class="btn btn-primary pull-right">
            ...
            <div class="well well-small">
                ...
                <span class="text-info">
                    (<?= lang('Code') . ', ' . lang('Name') . ', ' . lang('Base Unit') . ', ' . lang('Operator') . ', ' . lang('Operation Value' ); ?>)
                </span> <?= lang('csv3'); ?><br>
