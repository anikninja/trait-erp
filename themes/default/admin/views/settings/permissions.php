                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped reports-table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <span style="display:inline-block;">
                                            <input type="checkbox" value="1" class="checkbox" id="wallet-list" name="wallet-list" <?php echo $p->{'wallet-list'} ? 'checked' : ''; ?>>
                                            <label for="wallet-list" class="padding05"><?= lang( 'view-all-wallet' ); ?></label>
                                        </span>
                                        <span style="display:inline-block;">
                                            <input type="checkbox" value="1" class="checkbox" id="wallet-withdrawal_list" name="wallet-withdrawal_list" <?php echo $p->{'wallet-withdrawal_list'} ? 'checked' : ''; ?>>
                                            <label for="wallet-withdrawal_list" class="padding05"><?= lang('view-all-wallet-withdrawal-list') ?></label>
                                        </span>
                                        <span style="display:inline-block;">
                                            <input type="checkbox" value="1" class="checkbox" id="wallet-withdrawal_accept" name="wallet-withdrawal_accept" <?php echo $p->{'wallet-withdrawal_accept'} ? 'checked' : ''; ?>>
                                            <label for="wallet-withdrawal_accept" class="padding05"><?= lang('accept-wallet-withdrawal-request') ?></label>
                                        </span>
	                                    <span style="display:inline-block;">
                                            <input type="checkbox" value="1" class="checkbox" id="wallet-withdrawal_add" name="wallet-withdrawal_add" <?php echo $p->{'wallet-withdrawal_accept'} ? 'checked' : ''; ?>>
                                            <label for="wallet-withdrawal_add" class="padding05"><?= lang('create-wallet-withdrawal-request') ?></label>
                                        </span>
                                    </td>
                                </tr>
