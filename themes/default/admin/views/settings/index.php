...
<div class="box">
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                ?>
	                            <code><?= sprintf( lang( 'dateformat_output_x' ), date( $dateFormats['php_sdate'] ) ); ?></code>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
	                        ...
	                        <code><?= sprintf( lang( 'system_time_x' ), date( 'Y-m-d H:i:s T' ) ); ?></code>
                        </div>
                    </div>
                    <!--<div class="col-md-4">
                        <div class="form-group">
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="auto_create_delivery"><?= lang('auto_create_delivery'); ?></label>
                                <div class="controls"><?= form_dropdown('auto_create_delivery', [ 1 => lang( 'yes' ), 0 => lang( 'no' ) ], $auto_create_delivery, 'class="form-control tip" required="required" id="auto_create_delivery" style="width:100%;"'); ?></div>
	                            <code>Auto create pending delivery request upon frontend checkout.</code>
                            </div>
                        </div>
                    ...
                    <fieldset class="scheduler-border">
	                    <legend class="scheduler-border"><?= lang('commission_affiliate_referral' ) ?></legend>
	                    <div class="col-md-4">
		                    <div class="form-group">
			                    <label class="control-label" for="notification_email"><?= lang('notification_email'); ?></label>
			                    <div class="controls">
				                    <?= form_input([ 'type' => 'email', 'name'=> 'notification_email' ], $commission['notification_email'], 'class="form-control tip" id="notification_email"  style="width:100%;" required="required" title="Withdrawal Notification Email"'); ?>
			                    </div>
		                    </div>
	                    </div>
	                    <div class="col-md-4">
		                    <div class="form-group">
			                    <label class="control-label" for="minimum_withdrawal"><?= lang('minimum_withdrawal'); ?></label>
			                    <div class="controls">
				                    <?= form_input([ 'type' => 'number', 'name'=> 'minimum_withdrawal' ], $commission['minimum_withdrawal'], 'step="0.1" min="0" class="form-control tip" id="minimum_withdrawal"  style="width:100%;" required="required" title="Zero = No Limit"'); ?>
			                    </div>
		                    </div>
	                    </div>
	                    <div class="col-md-4">
		                    <div class="form-group">
			                    <label class="control-label" for="referral_url"><?= lang('referral_url'); ?></label>
			                    <div class="controls">
				                    <?= form_input([ 'type' => 'text', 'name'=> 'referral_url' ], $commission['referral_url'], 'class="form-control tip" id="referral_url"  style="width:100%;" required="required"'); ?>
			                    </div>
		                    </div>
	                    </div>
	                    <div class="col-md-4">
		                    <div class="form-group">
			                    <label class="control-label" for="referral_url"><?= lang('cookie_lifetime'); ?></label>
			                    <div class="controls">
				                    <?= form_input([ 'type' => 'number', 'name'=> 'cookie_lifetime' ], $commission['cookie_lifetime'], 'step="1" min="0" class="form-control tip" id="cookie_lifetime"  style="width:100%;" required="required" title="How many days before expire the referral/affiliate cookie. Default id 30 days"'); ?>
			                    </div>
		                    </div>
	                    </div>
                    </fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-xs-6">
                                        <?= lang('each_spent'); ?><br>
                                        <?= form_input('each_spent', $this->rerp->formatDecimal($Settings->each_spent), 'class="form-control"'); ?>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-xs-6">
                                        ...
                                        <?= form_input('each_sale', $this->rerp->formatDecimal($Settings->each_sale), 'class="form-control"'); ?>
                                    </div>
                                    <div class="col-sm-1 col-xs-1 text-center"><i class="fa fa-arrow-right"></i>
                                    </div>
                                    <div class="col-sm-4 col-xs-5">
    ...
    <div class="alert alert-info" role="alert">
	    ...
	    <p>For CLI: <code>schedule path/to/php path/to/index.php controller method</code></p>
    </div>
    <?php } ?>
</div>
</div>
