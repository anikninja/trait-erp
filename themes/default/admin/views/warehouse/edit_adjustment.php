...
<script type="text/javascript">
    ...
    ?>
        ...
        $("#add_item").autocomplete({
            source: '<?= admin_url('warehouse/qa_suggestions'); ?>',
            minLength: 1,
            autoFocus: false,
            delay: 250,
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('warehouse/edit_adjustment/' . $adjustment->id, $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) {
                    ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang('date', 'qadate'); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->rerp->hrld($adjustment->date)), 'class="form-control input-tip datetime" id="qadate" required="required"'); ?>
                                </div>
                            </div>
                        <?php
                } ?>
