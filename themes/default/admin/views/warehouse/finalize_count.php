    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('warehouse/finalize_count/' . $stock_count->id, $attrib);
    ...
    $(document).ready(function() {
        ...
        $('#download_csv').click(function(e) {
            ...
            if (type) {
                ...
                $('#stForm').attr('action', site.base_url+'warehouse/download_stock_count_csv').submit();
                // $('#csv_file').attr('required', 'required');

                // $.post(site.base_url+'warehouse/download_stock_count_csv', {type: type, categories: categories, barnds: brands}, function(data, textStatus, xhr) {
