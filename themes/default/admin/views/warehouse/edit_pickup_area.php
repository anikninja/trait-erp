...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PickupAreaList').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('warehouse/getPickupAreaList/' . $warehouse->id) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= sprintf( lang('edit_x'), sprintf( lang( 'pickup_x' ), lang( 'area' ) ) ) .' '. lang('for') . ' ' . $warehouse->code .' ('. $warehouse->name . ')'; ?> </h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				echo admin_form_open_multipart('warehouse/edit_pickup_area/'.$warehouse->id, $attrib); ?>
                <div class="col-md-3">
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-list"></i><?= lang( 'pickup' ) . ' ' . lang('area') . ' ' . lang('list') .' '. lang('for') . ' ' . $warehouse->code .' ('. $warehouse->name . ')'; ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
