...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('warehouse/getProductStock') ?>',
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, null, null, null, null, {"mRender": formatQuantity2}]
        });
    });
</script>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('warehouse/add_warehouse'); ?>" data-toggle="modal" data-target="#myModal">
                ...
                <div class="table-responsive">
                    <table id="CURData" class="table table-bordered table-hover table-striped table-condensed reports-table">
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?= lang('warehouse_code'); ?></th>
                            <th class="col-xs-3"><?= lang('warehouse_name'); ?></th>
