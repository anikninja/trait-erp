...
<script>
    $(document).ready(function () {
        oTable = $('#dmpData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('warehouse/getStockAdjustments/' . ($warehouse ? $warehouse->id : '')); ?>',
    ...
    ?>
        ...
        <?php $this->rerp->unset_data('remove_qals');
}
        ?>
    });
</script>
...
<?php if ($Owner || $GP['bulk_actions']) {
            echo admin_form_open('warehouse/adjustment_actions', 'id="action-form"');
        }
?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('warehouse/add_adjustment') ?>">
