...
<?php if ($Owner || $Admin) {
    ...
    <div class="row" style="margin-bottom: 15px;">
        <div class="box-quick-link">
            <div class="box-quick-link-wrap">
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="white quick-button small" href="<?= admin_url('products') ?>">
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="white quick-button small" href="<?= admin_url('sales') ?>">
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="white quick-button small" href="<?= admin_url('quotes') ?>">
                        <i class="lni-heart"></i>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="white quick-button small" href="<?= admin_url('purchases') ?>">
                        <i class="lni-plus"></i>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="white quick-button small" href="<?= admin_url('transfers') ?>">
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="white quick-button small" href="<?= admin_url('customers') ?>">
                        <i class="lni-emoji-cool"></i>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="white quick-button small" href="<?= admin_url('suppliers') ?>">
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="white quick-button small" href="<?= admin_url('notifications') ?>">
                        <i class="lni-alarm"></i>
				...
				<?php if ($Owner) {
					?>
                    <div class="col-lg-1 col-md-2 col-xs-6">
                        <a class="white quick-button small" href="<?= admin_url('auth/users') ?>">
                            <i class="lni-users"></i>
                            <p><?= lang('users') ?></p>
                        </a>
                    </div>
                    <div class="col-lg-1 col-md-2 col-xs-6">
                        <a class="white quick-button small" href="<?= admin_url('system_settings') ?>">
                            <i class="lni-cog"></i>
                            <p><?= lang('settings') ?></p>
                        </a>
                    </div>
...
<div class="row" style="margin-bottom: 15px;">
    <div class="col-md-12">
        <div class="box-latest-five">
            <div class="box-contentbox-latest-five-wrap">
                <div class="row">
                    <div class="col-md-12">
                                                ...
                                                <table id="sales-tbl" cellpadding="0" cellspacing="0" border="0"
													...
													<?php if (!empty($sales)) {
														...
														foreach ($sales as $order) {
                                                            ...
                                                            <td class="text-right">' . $this->rerp->formatMoney($order->grand_total) . '</td>
                                                            <td>' . row_status($order->payment_status) . '</td>
                                                            <td class="text-right">' . $this->rerp->formatMoney($order->paid) . '</td>
                                                        </tr>';
															$r++;
														}
													} else {
                                            ...
                                            <div class="table-responsive">
                                                <table id="quotes-tbl" cellpadding="0" cellspacing="0" border="0"
													...
													<?php if (!empty($quotes)) {
                                                        ...
                                                        <td>' . $this->rerp->hrld($quote->date) . '</td>
                                                        <td>' . $quote->reference_no . '</td>
                                                        <td>' . $quote->customer . '</td>
                                                        <td>' . row_status($quote->status) . '</td>
                                                        <td class="text-right">' . $this->rerp->formatMoney($quote->grand_total) . '</td>
                                                    </tr>';
															$r++;
														}
													} else {
                                        ...
                                        <div class="col-sm-12">
                                            <div class="table-responsive">
                                                <table id="purchases-tbl" cellpadding="0" cellspacing="0" border="0"
                                                    ...
                                                    <td>' . $this->rerp->hrld($purchase->date) . '</td>
                                                    <td>' . $purchase->reference_no . '</td>
                                                    <td>' . $purchase->supplier . '</td>
                                                    <td>' . row_status($purchase->status) . '</td>
                                                    <td class="text-right">' . $this->rerp->formatMoney($purchase->grand_total) . '</td>
                                                </tr>';
															$r++;
														}
													} else {
