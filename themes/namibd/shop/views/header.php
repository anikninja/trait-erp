...
<header class="header-style-1">
	...
	<div class="top-bar animate-dropdown" >
		<div class="container">
			<div class="header-top-inner">
				...
				<div class="cnt-block">
					<ul class="list-unstyled list-inline social-link-icon">
						<li class="social">
							<a target="_blank" href="https://www.facebook.com/Nami-BD-106604894704808/" class=""><i class="fa fa-facebook" aria-hidden="true"></i></a>
						</li>
						<li class="social">
							<a target="_blank" href="https://www.instagram.com/namibd_dotcom/" class=""><i class="fa fa-instagram" aria-hidden="true"></i></a>
						</li>
					</ul>
					<!-- /.list-unstyled -->
				</div>
	...
	<div class="main-header">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-2 logo-holder">
					<!-- ============================================================= LOGO ============================================================= -->
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 top-search-holder">
					<!-- /.contact-row -->
					<!-- ============================================================= SEARCH AREA ============================================================= -->
				...
				<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 animate-dropdown top-cart-row">
					...
					<div class="cell-phone">
						<a href="tel:<?php echo !empty($shop_settings->phone) ? str_replace(' ', '', $shop_settings->phone) : ''; ?>" class="lnk-cell">
							<div class="items-cell-inner">
								<div class="cell">
									<div class="cell-text"> <span class="lbl">Call Us Now: </span> <span class="value"><?php echo !empty($shop_settings->phone) ? $shop_settings->phone : ''; ?></span> </div>
								</div>
							</div>
						</a>
						<!-- /.dropdown-menu-->
