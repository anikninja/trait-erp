	                            ...
	                            <div class="no-print row">
		                            ...
		                            <div id="payment_attachment" class="payment_attachment col-md-12">
			                            ...
			                            <div class="form-group">
				                            <div class="bank_details" style="position: relative;display: block;margin: 0 auto;width: 100%;max-width: 320px;text-align: left;border: 2px solid #edf7c1;padding: 20px 10px;">
			                            ...
			                            <?php } ?>
			                            <div class="form-group">
                                            <span><?= lang( 'paid_offline_upload_button_prefix' ); ?></span>
				                            ...
				                            <label for="file" class="btn btn-default">
					                            ...
					                            <span><?= lang('select_payment_receipt_file'); ?></span>
				                            </label>
		                            ...
		                            <div id="payment_buttons" class="payment_buttons col-md-12" style="margin: 10px auto">
                                        <span><?= lang( 'paid_online_payment_using' ); ?></span>
			                            <?php
				                            $btn_code = '';
