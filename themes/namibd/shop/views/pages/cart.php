...
//		$shipping = $shipping['cost'] ? $this->rerp->convertMoney( $shipping['cost'], false, false ) : '';
		...
		<style>
            ...
            .cart-sidebar-footer .alert{
                color: black;
                font-weight: 700;
                font-size: 14px;
            }
            .cart-sidebar-footer .alert.alert-info {
                background: #fdd922;
            }
            .cart-sidebar-footer .alert.alert-info a {
                color: #ff0000;
            }
            .cart-sidebar-footer .alert.alert-warning {
                background: #6ee846;
            }
		</style>
    ...
    <div class="cart-sidebar-footer">
        <div class="alert alert-info" role="alert">
            <i class="fa fa-info-circle" aria-hidden="true"></i> For any problem call <a href="tel:<?php echo !empty($shop_settings->phone) ? str_replace(' ', '', $shop_settings->phone) : ''; ?>"><?php echo !empty($shop_settings->phone) ? $shop_settings->phone : ''; ?></a></div>
	    <?php
