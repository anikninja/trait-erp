                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?= form_password('new_password', set_value('new_password'), 'class="form-control tip" id="new_password" required="required" pattern="{6,}" placeholder="Create New Password For Your NamiBD Account"'); ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
