                ...
                <div class="col-md-6 col-sm-6 create-new-account">
	                ...
	                echo form_open('register', $attrib); ?>
                        ...
                        <div class="form-group">
	                        ...
	                        <?= form_password('password', '', 'class="form-control unicase-form-control text-input" id="reg_password" required="required" pattern="{6,}" placeholder="Create New Password For Your NamiBD Account"'); ?>
