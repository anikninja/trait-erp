		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="main-content sign-up-form" style="display: none;">
					...
					<input type="password" name="password" placeholder="Create New Password For Your Grocerant Account" pattern=".{6,}" required>
					...
					<p style="padding: 20px 0px 30px;">By signing up, you agree to Grocerant's <a href="<?= site_url( 'page/terms-of-service' ); ?>">Terms &amp; Condition</a></p>
					<button type="submit" class="button"><?= lang( 'continue' ); ?></button>
					<?= form_close(); ?>
