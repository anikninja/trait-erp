		...
		<div class="checkout-box">
			<div class="row">
							...
							<div class="wishlist-wrap table-responsive">
								<table class="wishlist-items text-center">
									...
									<tr>
										...
										<th style="min-width: 120px; max-width: 300px;"><?= lang('description') ?></th>
										<th><?= lang('price') ?></th>
									...
									<?php foreach ( $items as $item ) {
										...
										<tr class="<?php echo $prodClasses; ?>" data-product='<?php echo safeJsonEncode( $item ); ?>'>
											...
											<td style="min-width: 120px; max-width: 300px; overflow: hidden; text-overflow: ellipsis; text-align: left">
												<a class="view-product" href="<?= $item->link; ?>"><?= $item->name; ?></a>
												<div class="hidden-xs"><?= character_limiter($item->custom_data['short_description'], 190); ?></div>
											</td>
											<td><?php
												if ( $item->onSale ) {
				...
				<div class="col-xs-12 col-sm-9 col-md-10">
					<div class="alert alert-info text-center empty-wishlist" role="alert">
