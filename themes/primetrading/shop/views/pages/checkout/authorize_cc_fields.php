	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input name="card_expiry" type="text" id="card_expiry" class="form-control" placeholder="mm/yy">
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				<label for="security" class=""><?= lang( 'security_code' ); ?></label>
				<input name="security" type="text" id="security" class="form-control" placeholder="<?= lang( 'cvv2' ); ?>">
			</div>
		</div>
	</div>
</div>
