...
<div class="panel panel-default checkout-step-03">
    <div class="checkout-step-header-wrap">
        <div class="checkout-step-header"><div class="step-num"><?= $step; ?></div><?= lang( 'delivery_slot' ); ?></div>
    </div>
    <div class="checkout-step-content-wrap">
        <div class="row delivery-slot-wrap" style="display:none;">
            <div class="deliver-slot-form">
                ...
                <div class="col-md-8">
                    <div class="selected-slot"><?= lang( 'selected_slot' ); ?><span><?php
	                    if ( $this->loggedIn ) {
