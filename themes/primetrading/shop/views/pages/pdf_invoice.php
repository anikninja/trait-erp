	                        ...
	                        <table class="table table-bordered table-hover table-striped">
	                            ...
	                            <tbody>
	                                ...
	                                <tr>
	                                    ...
	                                    <?php
	                                    if ($Settings->tax1 && $inv->product_tax > 0) {
	                                        echo '<td style="width: 90px; text-align:right; vertical-align:middle;">' . ($row->item_tax != 0 && $row->tax_code ? '<small>(' . $row->tax_code . ')</small> ' : '') . $this->rerp->formatMoney($row->item_tax) . '</td>';
	                                    }
	                                    if ($Settings->product_discount && $inv->product_discount != 0) {
	                            ...
	                            <tfoot>
	                                ...
	                                <?php if ($inv->grand_total != $inv->total) {
	                                    ?>
	                                    <tr>
	                                        <td colspan="<?= $tcol; ?>" style="text-align:right;"><?= lang('total'); ?> (<?= $default_currency->code; ?>)</td>
	                                        <?php
	                                        if ($Settings->tax1 && $inv->product_tax > 0) {
	                                ...
	                                <?php if ($Settings->indian_gst) {
	                                    if ($inv->cgst > 0) {
		                                    ...
		                                    echo '<td style="text-align:right; font-weight:bold;">' . ($Settings->format_gst ? $this->rerp->formatMoney($cgst) : $cgst) . '</td></tr>';
	                                    }
	                                    if ($inv->sgst > 0) {
		                                    ...
		                                    echo '<td style="text-align:right; font-weight:bold;">' . ($Settings->format_gst ? $this->rerp->formatMoney($sgst) : $sgst) . '</td></tr>';
	                                    }
	                                    if ($inv->igst > 0) {
		                                    ...
		                                    echo '<td style="text-align:right; font-weight:bold;">' . ($Settings->format_gst ? $this->rerp->formatMoney($igst) : $igst) . '</td></tr>';
	                                    }
	                                } ?>
	                                <?php
	                                if ($return_sale) {
	                                ...
	                                if ($inv->surcharge != 0) {
	                                    echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang('return_surcharge') . ' (' . $default_currency->code . ')</td>';
		                                echo '<td style="text-align:right;">' . $this->rerp->formatMoney($inv->surcharge) . '</td></tr>';
	                                }
	                                ?>
	                                <?php if ($inv->order_discount != 0) {
	                                    echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang('order_discount') . ' (' . $default_currency->code . ')</td>';
	                                ...
	                                <?php if ($Settings->tax2 && $inv->order_tax != 0) {
	                                    echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang('order_tax') . ' (' . $default_currency->code . ')</td>';
	                                ...
	                                <?php if ($inv->shipping != 0) {
	                                    echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang('shipping') . ' (' . $default_currency->code . ')</td>';
