<div class="clearfix mobile-filters-container visible-xs">
	<div class="mobile-filter-trigger">
		<ul>
            ...
            <li>
                <a href="#" data-id="#brand-filter"><i class="fa fa-star" aria-hidden="true"></i><?= lang( 'brands' ); ?></a>
            </li>
            <li>
	...
	<div class="mobile-filters-body">
		<div class="single-filter-body" id="category-filter">
            <?php echo build_category_tree( $categories, isset( $selected_categories ) ? $selected_categories : [], [ 'mobile-sub-category-list' ] ); ?>
		</div>
        <div class="single-filter-body" id="brand-filter">
            <ul>
				<?php
				foreach ( $brands as $brand ) {
					...
					?>
                    <li><a href="<?php echo site_url( 'brand/' . $brand->slug ); ?>"><?php echo $brand->name; ?></a>
                    </li>
					<?php
				}
				?>
		...
		<div class="single-filter-body" id="other-filter">
			...
			<div class="sidebar-widget-body m-t-10">
				<div class="price-range-holder">
					...
					<input type="text" id="price-range" name="price_range" class="price-range price-slider" value="<?php echo $priceRange ?>" data-min="<?php echo round( $price_range->min, 2 ); ?>" data-max="<?php echo round( $price_range->max, 2 ); ?>" data-value="[<?php echo $priceRange; ?>]">
				</div>
				<!-- /.price-range-holder -->
			</div>
			<!-- /.sidebar-widget-body -->
