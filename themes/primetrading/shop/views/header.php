...
//		printf( '<link rel="preload" as="style" href="%scss/%s">', $assets, $css );
    ...
    $storeNotice = isset( $theme_options['header']['top']['content'] ) ? html_entity_decode( $theme_options['header']['top']['content'] ) : false;
...
<header class="cs-header">
	...
	<div class="header-top">
		<div class="container"><?= $storeNotice; ?></div>
	</div>
	<!-- /.header-top -->
	<?php } ?>
    <div class="header-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-sm-3 col-md-2 col-xs-4 logo-wrap">
                    <div class="site-logo">
                        <a href="<?= site_url(); ?>">
                ...
                <div class="col-lg-7 col-sm-4 col-md-6 col-xs-8 header-mini-wrap">
                    <div class="row">
                        <div class="site-search col-lg-12">
                            ...
                            <div class="search input-group form-group">
                                <div class="select_category filter_type hidden-xs hidden-sm">
                                    <select class="no-border chosen-select" style="display: none" name="__category">
                                        ...
                                        echo build_category_option_tree( $categories, $selected );
                                        ?>
                                    </select>
                                </div>
                ...
                <div id="nav-tools" class="layoutToolbarPadding col-lg-3 col-sm-5 col-md-4 col-xs-7">

                        <div class="header-account nav-item has-dropdown account">
                            <a href="#">
                                <div class="nav-line-1-container hidden-xs">
                                ...
                                <span class="nav-line-2 nav-long-width hidden-xs">Account &amp; Lists<span class="nav-icon nav-arrow" style="visibility: visible;"></span> </span>
                                </span>
                        ...
                        <div class="header-returns">
                            <a href="https://beautygirlusa.com/page/for-business" class="btn btn-special">For Business</a>
                        </div>
