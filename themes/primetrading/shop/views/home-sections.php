...
if ( isset( $theme_options['main'] ) && ! empty( $theme_options['main'] ) ) {
	foreach ( $theme_options['main'] as $section ) {
		...
		elseif ( $section['type'] == 'daily_deals' ) {
			...
			?>
			<div class="module deals-layout1 daily_deals <?= $section['type']; ?>">
				...
				<div class="modcontent">
					<div class="so-deal clearfix preset00-2 preset01-1 preset02-1 preset03-1 preset04-1  button-type2  style2">
						<div class="sidebar-slider-inner products-list " data-effect="none">
							<?php foreach( $section['products'] as $product ) { ?>
								<div class="item"><?php get_single_product_loop_second_layout( $product, true, true ); ?></div>
							<?php } ?>
						</div>
					</div>
				</div>
		...
		elseif ( $section['type'] == 'trending_products' ) {
			...
			$prodCount = count( $section['products'] );
			?>
			<!-- ============================================== SCROLL TABS ============================================== -->
			<div class="scroll-tabs outer-top-vs">
				<div class="more-info-tab clearfix ">
					...
					<ul class="nav nav-tabs nav-tab-line pull-right">
						<li class="active"><a href="#all-<?php $rand_all = rand(); echo $rand_all; ?>" data-toggle="tab">All</a></li>
						<?php
						$rand_array = array();
						foreach ( $categoriesToShow as $key => $category ) {
							...
							?>
							<li>
								<a href="#category-<?php echo $category->slug . '-' . $rand_array[$key]; ?>" data-toggle="tab"><?php echo $category->name; ?></a>
							</li>
						<?php } ?>
					</ul>
					<!-- /.nav-tabs -->
				...
				<div class="tab-content outer-top-xs">
					<div class="tab-pane in active" id="all-<?= $rand_all; ?>">
						<div class="products">
							<div class="product-slider">
								<div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="5">
								<?php
								if ( $prodCount > 5 ) {
									foreach ( array_chunk( $section['products'], 2 ) as $products ) { ?>
										<div class="item item-carousel">
											<?php foreach ( $products as $product ) {
												get_single_product_loop_layout( $product, false, true );
											} ?>
										</div><!-- /.item -->
									<?php }
								} else {
									foreach ( $section['products'] as $product ) {
										?>
										<div class="item item-carousel"><?php get_single_product_loop_layout( $product, false, true ); ?></div><!-- /.item -->
										<?php
									}
								}
								?>
					...
					<?php foreach ( $categoriesToShow as $key => $category ) {
						...
						<div class="tab-pane" id="category-<?php echo $category->slug . '-' . $rand_array[$key]; ?>">
							<div class="products">
								<div class="product-slider">
									<div class="owl-carousel home-owl-carousel home-tab-slider custom-carousel owl-theme" data-item="5">
									<?php foreach ( $category->products as $product ) { ?>
										<div class="item item-carousel"><?php get_single_product_loop_layout( $product, false, true ); ?></div>
									<?php } ?>
									</div>
									<!-- /.home-owl-carousel -->
								</div>
				...
				<div class="more-info-tab clearfix ">
					...
					<ul class="nav nav-tabs nav-tab-line pull-right">
						...
						<?php foreach ( $categoriesToShow as $category ) {
							...
							?>
							<li>
								<a href="#category-<?php echo $category->slug; ?>" data-toggle="tab"><?php echo $category->name; ?></a>
							</li>
						<?php } ?>
					</ul>
					<!-- /.nav-tabs -->
						...
						<div class="products">
							<div class="product-slider">
								<div class="no-carousel" data-item="5">
									<?php
                                    if ( $showSidebar ) {
                                    $first_product = array_slice( $section['products'], 0, 1); ?>
									...
									<?php
	                                    ...
	                                    $new_products_slice = array_slice( $section['products'], 0, 10 );
                                    }
							...
							<div class="products">
								<div class="product-slider">
									<div class="no-carousel">
										<?php
										if ( $showSidebar ) {
											$first_product = array_slice( $category->products, 0, 1); ?>
                                            <div class="item item-carousel first_product">
												<?php get_single_product_loop_layout( $first_product[0] ); ?>
                                            </div>
											<?php
											...
											$new_products_slice = array_slice( $category->products, 0, 10 );
										}
		...
		?>
			...
			<section class="section featured-product">
				<div class="row">
					...
					<div class="col-lg-9">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs products product-slider" data-item="4">
							<?php
							foreach ( $section['products'] as $product ) { ?>
								<div class="item item-carousel">
		...
		?>
			<!-- ============================================== FEATURED PRODUCTS ============================================== -->
			<section class="section new-arrivals module">
                <h3 class="modtitle"><span><?php echo $section['label']; ?></span></h3>
				<div class="owl-carousel home-owl-carousel custom-carousel owl-theme product-slider" data-item="5">
					<?php
					foreach ( $section['products'] as $product ) { ?>
						<div class="item item-carousel">
							<?php get_single_product_loop_layout( $product, false, true ); ?>
