...
<?= form_open('login', 'class="validate register-form outer-top-xs"'); ?>
    <div class="form-group">
        <label for="username" class="info-title control-label"><?= lang('identity'); ?> <span>*</span></label>
        <input type="text" name="identity" id="username" class="form-control unicase-form-control text-input" value="" required placeholder="<?= lang('email'); ?>">
    </div>
    <div class="form-group">
...
<?php if ( isset( $_GET['redirect_to'] ) ) { ?>
	<input type="hidden" name="" value="<?= xss_clean( $_GET['redirect_to'] ); ?>">
<?php } ?>
